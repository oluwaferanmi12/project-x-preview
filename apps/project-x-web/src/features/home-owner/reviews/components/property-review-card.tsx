...
export const PropertyReviewCard = ({
  ...
  <Container
    className="grid min-h-21 grid-cols-[120px_minmax(0,1fr)] overflow-hidden rounded-lg border border-line bg-surface transition hover:border-s500"
  >
    ...
    <Container className="flex min-w-0 flex-col px-3 py-2">
      ...
      <Container className="mt-auto flex items-center gap-2 pt-2 text-secondary">
